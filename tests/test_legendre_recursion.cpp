...
bool test_legendre_array_recursion_is_correct_to_order_6(double x)
{
...
int main()
{
    assert(test_legendre_array_recursion_is_correct_to_order_6(-1.0));
    assert(test_legendre_array_recursion_is_correct_to_order_6(1.0));
    assert(test_legendre_array_recursion_is_correct_to_order_6(0.0));
    assert(test_legendre_array_recursion_is_correct_to_order_6(0.3));
